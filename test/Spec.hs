...
lexerTest2 = testEqual "Tokenization of mathematical expressions"
    ...
    LiteralDecimal 2 3 2, Operator NotEqual, LiteralInteger 10 7, Operator LowerThan, Operator Minus, Operator ShiftLeft, Identifier "fu",
    Operator Apply, LiteralInteger 16 16]
