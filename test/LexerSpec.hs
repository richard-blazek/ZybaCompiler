...
test1 = testEqual "Tokenization of the first code"
  ...
  (2, LiteralReal 9 5 0), (2, Operator "-"), (2, LiteralReal 10 4404 3), (2, Operator "/"), (2, Name "abh_hc")]
...
test2 = testEqual "Tokenization of the second code"
  ...
  (1, LiteralInt 10 7), (1, Operator ":"), (1, LiteralInt 10 5), (1, Operator "->"), (1, Name "var"),
  ...
  (1, Operator "!="), (1, LiteralInt 10 7), (1, Operator "<"), (1, Operator "-"), (1, Operator "<<"), (1, Name "fu"),
...
test4 = testEqual "Tokenization of the fourth code"
  [(0, Name "fun"), (2, Name "power"), (2, Separator '['), (2, Name "n"), (2, Name "exp"), (2, Separator ']'), (2, Name "if"),
  (2, Name "f"), (2, Separator '['), (2, Name "exp"), (2, Separator ']'), (2, Operator "="), (2, LiteralInt 10 0),
  (2, LiteralInt 10 1), (2, Name "else"), (2, Name "f"), (2, Separator '['), (2, Name "n"), (2, Separator ']'), (2, Operator "*"),
  (2, Name "power"), (2, Separator '['), (2, Name "f"), (2, Separator '['), (2, Name "n"), (2, Separator ']'), (2, Name "f"),
  (2, Separator '['), (2, Name "exp"), (2, Separator ']'), (2, Operator "-"), (2, LiteralInt 10 1), (3, Separator ']'),
  (3, Name "is"), (3, Name "is")]
  $ tokenize "fun\n\npower [n exp] if f[exp] = 0 1 else f[n] * power[f[n] f[exp] - 1]\nis is"

test5 = testEqual "Tokenization of an incorrent code"
  [(0, Name "stri"), (7, LiteralInt 10 2), (7, LiteralText "###\"```"), (7, LiteralInt 10 987), (7, Operator "<=="),
