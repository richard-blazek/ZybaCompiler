...
test4 = testEqual "Tokenization of the fourth code"
  ...
  (2, Word "f"), (2, Separator '['), (2, Word "exp"), (2, Separator ']'), (2, Operator "="), (2, LiteralInt 10 0),
  (2, LiteralInt 10 1), (2, Word "else"), (2, Word "f"), (2, Separator '['), (2, Word "n"), (2, Separator ']'), (2, Operator "*"),
  (2, Word "power"), (2, Separator '['), (2, Word "f"), (2, Separator '['), (2, Word "n"), (2, Separator ']'), (2, Word "f"),
  (2, Separator '['), (2, Word "exp"), (2, Separator ']'), (2, Operator "-"), (2, LiteralInt 10 1), (3, Separator ']'),
  (3, Word "is"), (3, Word "is")]
